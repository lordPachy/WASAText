...
privid="$(curl -s --header "Content-Type: application/json" --header "Authorization: ${pippoauth}" --request PUT --data '{"isgroup":false, "members":[{"name":"Topolino"}]}' http://0.0.0.0:3000/conversations)"
printf "$privid\n"
printf "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"
...
curl -s --header "Content-Type: application/json" --header "Authorization: ${pippoauth}" --data $privid --request POST http://0.0.0.0:3000/conversations/$groupid/messages/$topolinomessid -v
printf "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"
