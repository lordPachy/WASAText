...
printf "${GROUP_ADDING}\n"
curl -s --header "Content-Type: application/json" --header "Authorization: ${paperoneauth}" --request PUT --data $GROUP_ADDING http://0.0.0.0:3000/groups
printf "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"
GROUP_ADDING=$(printf '{
...
printf "${GROUP_ADDING}\n"
curl -s --header "Content-Type: application/json" --header "Authorization: ${pippoauth}" --request PUT --data $GROUP_ADDING http://0.0.0.0:3000/groups
printf "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"
GROUP_ADDING=$(printf '{
    "username": {"name": "Paperoga"},
    "group": %s
...
curl -s --header "Content-Type: application/json" --header "Authorization: ${paperoneauth}" --request DELETE http://0.0.0.0:3000/conversations/$groupidnum
printf "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"
