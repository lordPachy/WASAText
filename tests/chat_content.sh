...
privid="$(curl -s --header "Content-Type: application/json" --header "Authorization: ${pippoauth}" --request PUT --data '{"isgroup":false, "members":[{"name":"Topolino"}], "groupname":null}' http://0.0.0.0:3000/conversations | jq '.id')"
printf "$privid\n"
printf "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"
printf "PRIVATE CHAT MESSAGE\n"
curl -s --header "Content-Type: application/json" --header "Authorization: ${pippoauth}" --request POST --data '{"content":"Hi, Im Pippo", "replyingto":-1}' http://0.0.0.0:3000/conversations/$privid
printf "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"
...
printf "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"
printf "CHAT RETRIEVAL FROM TOPOLINO\n"
curl -s --header "Content-Type: application/json" --header "Authorization: ${topolinoauth}" --request GET http://0.0.0.0:3000/conversations
printf "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"
