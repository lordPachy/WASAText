...
curl -s --header "Content-Type: application/json" --header "Authentication: ${pippoauth}" --request DELETE http://0.0.0.0:3000/conversations/$groupid/messages/$topolinomessid -v
printf "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"
