...
CREATE TABLE groupmembers (id INTEGER, member TEXT NOT NULL, PRIMARY KEY (id, member), FOREIGN KEY (member) REFERENCES users(username) ON UPDATE CASCADE, FOREIGN KEY (id) REFERENCES groupchats(id));
